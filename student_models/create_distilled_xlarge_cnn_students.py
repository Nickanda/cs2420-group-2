...
class StudentModel(nn.Module):
    def __init__(self):
        ...
        self.network = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Conv2d(64, 64, kernel_size=3, padding=1),  # Added extra conv layer
            nn.BatchNorm2d(64),
            nn.ReLU(),
            ...
            nn.BatchNorm2d(128),
            nn.ReLU(),
            nn.Conv2d(128, 128, kernel_size=3, padding=1),# Added extra conv layer
            nn.BatchNorm2d(128),
            nn.ReLU(),
            ...
            nn.BatchNorm2d(256),
            nn.ReLU(),
            nn.Conv2d(256, 256, kernel_size=3, padding=1),# Added extra conv layer
            nn.BatchNorm2d(256),
            nn.ReLU(),
            nn.MaxPool2d(2, 2),                           # Output: 4 x 4 x 256

            # Fourth convolutional block
            nn.Conv2d(256, 512, kernel_size=3, padding=1),# Added new conv block
            nn.BatchNorm2d(512),
            nn.ReLU(),
            nn.Conv2d(512, 512, kernel_size=3, padding=1),# Added extra conv layer
            nn.BatchNorm2d(512),
            nn.ReLU(),
            nn.MaxPool2d(2, 2),                           # Output: 2 x 2 x 512

            nn.Flatten(),
            nn.Linear(2 * 2 * 512, config.hidden_dim * 2),# Adjusted input size and increased hidden_dim
            nn.ReLU(),
